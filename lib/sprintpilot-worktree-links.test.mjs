...
import { forgetWorktreeLink, persistWorktreeLink, persistedWorktreeLinks, persistedWorktreeRepositories } from "./sprintpilot-worktree-links.ts";
...
test("persists Jira worktree links across module reads", async (t) => {
  ...
  assert.deepEqual(persistedWorktreeRepositories(), ["/repos/arnac"]);
